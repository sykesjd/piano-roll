		...
		$.each(data['allnotes']['tracks'], function(i,val){
			...
			$.each(val['notes'], function(j, value){
				...
				if (part >= 2 && style == "Song") {
					...
					switch (type) {
						case 0: $('<div></div>').addClass('note').addClass('part' + part).css({'width':width,'left':value['start']+200,'height':(168/range)+'vh','top':y+'vh','border-radius':width/2+'px / '+(84/range)+'vh'}).appendTo('body');
						case 1: $('<div></div>').addClass('note').addClass('part' + part).css({'width':width,'left':value['start']+200,'height':(168/range)+'vh','top':y+'vh','border-radius':width/4+'px / '+(84/range)+'vh'}).appendTo('body');
						case 2: $('<div></div>').addClass('note').addClass('part' + part).css({'width':width,'left':value['start']+200,'height':(168/range)+'vh','top':y+'vh','border-radius':width/3+'px / '+(84/range)+'vh'}).appendTo('body');
						case 3: $('<div></div>').addClass('note').addClass('part' + part).css({'width':width,'left':value['start']+200,'height':(168/range)+'vh','top':y+'vh','border-radius':(84/range)+'vh'}).appendTo('body');
						case 4: $('<div></div>').addClass('note').addClass('part' + part).css({'width':width,'left':value['start']+200,'height':(168/range)+'vh','top':y+'vh'}).appendTo('body');
						case 5: $('<div></div>').addClass('note').addClass('sp' + part).css({"left":value['start']+200,"top":y+'vh'}).append($('<div></div>').addClass('spu').css({'border-bottom-width':(84/range)+'vh','border-left-width':width/2+'px','border-right-width':width/2+'px'})).append($('<div></div>').addClass('spd').css({'border-top-width':(84/range)+'vh','border-left-width':width/2+'px','border-right-width':width/2+'px'})).appendTo('body');
						...
						case 7: $('<div></div>').addClass('note').addClass('sp' + part).addClass('spu').css({'left':value['start']+200,'top':y+'vh','border-bottom-width':(168/range)+'vh','border-left-width':width/2+'px','border-right-width':width/2+'px'}).appendTo('body');
						case 8: $('<div></div>').addClass('note').addClass('part' + part).css({'width':'5px','left':value['start']+200,'height':(168/range)+'vh','top':y+'vh'}).appendTo('body');
						case 9: $('<div></div>').addClass('note').addClass('part12').css({'width':'5px','left':value['start']+200,'height':(168/range)+'vh','top':y+'vh'}).appendTo('body');
					}
				}
